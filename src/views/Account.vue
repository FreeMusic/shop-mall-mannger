<template>
    ...
    <el-card class="account-container">
        <el-form :model="passForm" :rules="rules" ref="paddRef" label-width="80px" label-position="right" class="demo-ruleForm">
            <el-form-item label="原密码：" prop="oldpass">
                <el-input style="width: 200px" v-model="paddForm.oldpass"></el-input>
            </el-form-item>
...
<script>
    ...
    export default {
        ...
        setup() {
            ...
            return {
                ...toRefs(state),
                nameRef, paddRef, submitName, submitPass
            }
        }
    }
</script>
