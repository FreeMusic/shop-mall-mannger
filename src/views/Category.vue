<template>
    <el-card class="category-container">
        ...
        >
            ...
            <el-table-column prop="操作" width="220">
    ...
    <DialogAddCategory
            ref="addGood" :reload="getCategory" :type="type"
    ...
    export default {
        ...
        setup() {
            ...
            return {
                ...
                addGood, handleAdd, handleEdit, handleDelete, handleDeleteOne,
                getCategory, changePage, handleNext
            }
        }
    }
</script>
