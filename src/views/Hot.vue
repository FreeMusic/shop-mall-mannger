<template>
        ...
        >
            ...
            <el-table-column label="操作" width="100">
                <template #default="scope">
                    ...
                    <el-popconfirm title="确定删除吗?" @confirm="handleDeleteOne(scope.row.configId)">
                        <template #reference>
    ...
    <DialogAddGood ref="addGood" :reload="getIndexConfig" :type="type" :config-type="configType"></DialogAddGood>
</template>
