        ...
        <el-card class="add-container">
            <el-form :model="goodForm" :rules="rules" ref="goodRef" label-width="100px" class="goodForm">
                ...
                <el-form-item label="商品名称" prop="goodsName">
                    <el-input style="width: 300px" v-model="goodForm.goodsName" placeholder="输入商品名称"></el-input>
                </el-form-item>
                ...
                <el-form-item label="商品售卖价" prop="sellingPrice">
                    <el-input type="number" min="0" style="width: 300px" v-model="goodForm.sellingPrice" placeholder="请输入商品售卖价"></el-input>
                </el-form-item>
                ...
                <el-form-item required label="商品主图" prop="goodsCoverImg">
                    ...
                    >
                        <img style="width: 300px;" v-if="goodForm.goodsCoverImg" :src="goodForm.goodsCoverImg" class="avatar">
    ...
    export default {
        ...
        setup() {
            ...
            onMounted(() => {
                ...
                instance.config.uploadImgMaxSize = 20 * 1024 * 1024
                ...
                instance.config.uploadImgHooks = {
                    //图片上传并返回了结果  想要自己吧图片插入到编辑器中
                    customInsert: function(insetImgFn, result) {
                        console.log('result', result)
                        if (result.data && result.data.length) {
                            result.data.forEach(item => insetImgFn(item))
                        }
                    }
                }
            ...
            const submitAdd = () => {
                goodRef.value.validate((vaild) => {
                    if (vaild) {
                        ...
                        if (hasEmoji(params.goodsIntro) || hasEmoji(params.goodsName) || hasEmoji(params.tag)
            ...
            return {
                ...toRefs(state),
                goodRef, submitAdd, handleBeforeUpload, handleUrlSuccess, editor, handleChangeCate
            }
        }
    }
</script>
